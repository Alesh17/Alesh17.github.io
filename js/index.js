...
// Импорт скриптов плагина iziToast

// Функция отрабатывает, как только DOM полностью загрузился
// Импорт стилей для страницы index.html
...
$(function () {
    ...
    // Создание объекта содержащего настройки плагина
    var pluginOptions = {
    ...
    $('#portfolio-grid').justifiedGallery(pluginOptions);
...
// Ссылка на плагин - http://izitoast.marcelodolce.com
...
(function (root, factory) {
  ...
  */
	$iziToast.hide = function ($toast, options, closedBy) {
		...
		if ((typeof $toast === 'undefined' ? 'undefined' : _typeof($toast)) != 'object') {
